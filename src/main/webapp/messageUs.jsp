...
<form action="messageUsAction.jsp" method=post>
	<input type="text" class="input-style" name="subject" placeholder="Subject Here">
<hr>
<textarea rows="" cols="" class="input-style" name="body" placeholder="Enter Your Message" required></textarea>
<hr>
